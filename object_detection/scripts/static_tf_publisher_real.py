...
# Without this node, the tfs can sometimes stop being published
# thus causing malfunctions during the object detection
class StaticTransformPublisher:
    ...
    def publish_static_transform(self) -> None:
        ...
        static_transform_stamped.transform.rotation.x = 0.062 
        static_transform_stamped.transform.rotation.y = 0.062  
        static_transform_stamped.transform.rotation.z = -0.704 
        static_transform_stamped.transform.rotation.w = 0.705 
